...
def analyze_results(results_dir):
    ...
    agg_stats = combined_df.groupby(
        ['config_type', 'delta_k', 'brake_threshold']).agg({
    ...
    agg_stats.columns = [
        'config_type', 'delta_k', 'brake_threshold', 'collision_rate',
        'collision_std', 'num_runs', 'avg_delta_k_used', 'delta_k_std'
    ]
    ...
    for delta_k in agg_stats['delta_k'].unique():
        ...
        plt.errorbar(data['brake_threshold'],
                     data['collision_rate'],
